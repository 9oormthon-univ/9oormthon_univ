    ...
    <div className={cx('container')}>
      ...
      <div className={cx('bottomSection')}>
        <div className={cx('targetBox')}>
          ...
          <Text className={cx('show-on-lg')} as="h4" color="text-alternative" typography="heading4" fontWeight="bold">
            IT 서비스의 구현에
            <br /> 관심이 많은 대학생
          </Text>

          <Text className={cx('show-on-md')} as="h5" color="text-alternative" typography="heading5" fontWeight="bold">
            IT 서비스의 구현에
            <br /> 관심이 많은 대학생
          </Text>
        </div>
