        ...
        <div className={cx('rowLayout')}>
          ...
          <div className={cx('cardLayout')}>
            <div className={cx('textLayout')}>
              <Text as="h5" color="text-normal" typography="heading5" fontWeight="bold" className={cx('cardTitleText')}>
                활동 기간
              </Text>
              <Text as="p" color="text-hint" typography="body1" fontWeight="regular" className={cx('cardParagraph')}>
                6월부터 12월까지 <br />
                활동 가능해야 합니다.
              </Text>
            </div>
